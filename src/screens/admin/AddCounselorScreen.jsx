...
const AddCounselorScreen = ({ navigation }) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            showToast.success('Success', 'Counselor added successfully');
            navigation.goBack();
        } catch (error) {
            console.error('Add counselor error:', error);
            const message = error.response?.data?.message || 'Failed to add counselor';
            ...
            >
                ...
                >
                    <View style={[styles.formCard, shadows.lg]}>
                        <Text style={styles.formTitle}>Counselor Information</Text>
...
export default AddCounselorScreen;
